...
const PhoneSettings = ({navigation}) => {
    const [email,setEmail] = useState("");
  return (
   <View>
    <Text style={{fontWeight:"500", fontSize:24, marginLeft:20,marginTop:20}}>Change phone number</Text>
    <GeneralInput name={"Phone number"} value={email} onChangeValue={setEmail} width={333}/>
